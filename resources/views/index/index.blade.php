...
<head>
	...
	<title>品优购，优质！优质！</title>
	 <link rel="icon" href="assets//reception/img/favicon.ico">

    <link rel="stylesheet" type="text/css" href="/reception/css/webbase.css" />
    <link rel="stylesheet" type="text/css" href="/reception/css/pages-JD-index.css" />
    <link rel="stylesheet" type="text/css" href="/reception/css/widget-jquery.autocomplete.css" />
    <link rel="stylesheet" type="text/css" href="/reception/css/widget-cartPanelView.css" />
</head>
					...
					<div id="myCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
					  ...
					  <div class="carousel-inner">
					    ...
					    <a href="http://baidu2.wypxj.com/">
					    	<img src="/reception/img/banner1.jpg"  />
					      </a>
					    </div>
					    <div class="item">
						 <a href="http://baidu2.wypxj.com/">
						<img src="/reception/img/banner2.jpg"  />
					     </a>
					    </div>
					    <div class="item">
						 <a href="http://baidu2.wypxj.com/">
						<img src="/reception/img/banner3.jpg"  />
						</a>
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				<li class="yui3-u-1-6  clock">
					<div class="time">
						<img src="/reception/img/clock.png" />
						<h3>今日推荐</h3>
					</div>
				</li>
				<li class="yui3-u-5-24">
					<a href="list.html" target="_blank"><img src="/reception/img/today01.png" /></a>
				</li>
				<li class="yui3-u-5-24">
					<img src="/reception/img/today02.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="/reception/img/today03.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="/reception/img/today04.png" />
				</li>
			</ul>
		</div>
	</div>
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="" class="pic"><img src="/reception/img/like_02.png" alt="" /></a>
								<div class="like-text">
							...
							<dd>
								<a href="" class="pic"><img src="/reception/img/like_01.png" alt="" /></a>
								<div class="like-text">
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="" class="pic"><img src="/reception/img/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							...
							<dd>
								<a href="" class="pic"><img nsrc="assets//reception/img/like_02.png" alt="" /></a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
									<h3>¥566.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/reception/img/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>捷波朗 </p>
									<p>（jabra）BOOSI劲步</p>
									<h3>¥236.00</h3>
							...
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/reception/img/like_02.png" alt="" /></a>
								<div class="like-text">
									<p>欧普</p>
									<p>JYLZ08面板灯平板灯铝</p>
									<h3>¥456.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/reception/img/like_01.png" alt="" /></a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
									<h3>¥566.00</h3>
							...
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img nsrc="assets//reception/img/like_02.png" alt="" /></a>
								<div class="like-text">
		...
		<div class="py-container">
			...
			<div class="clearfix yui3-g Interest">
				...
				<div class="yui3-u row-405 Interest-conver">
					<img src="/reception/img/interest01.png" />
				</div>
				<div class="yui3-u row-225 Interest-conver-split">
					<h5>好东西</h5>
					<img src="/reception/img/interest02.png" />
					<img src="/reception/img/interest03.png" />
				</div>
				<div class="yui3-u row-405 Interest-conver-split blockgary">
					<h5>品牌街</h5>
					<div class="split-bt">
						<img src="/reception/img/interest04.png" />
					</div>
					<div class="x-img fl">
						<img src="/reception/img/interest05.png" />
					</div>
					<div class="x-img fr">
						<img src="/reception/img/interest06.png" />
					</div>
				</div>
				<div class="yui3-u row-165 brandArea">
					<span class="brand-yline"></span>
					<ul class="yui3-g brand-list">
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand01.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand02.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand03.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand04.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand05.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand06.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand07.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand08.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand09.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand10.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand11.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand12.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand13.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/reception/img/brand03.png" /></li>
					</ul>
				</div>
			</div>
				...
				<div id="tab1" class="tab-pane active">
					<div class="yui3-g Floor-1">
						<div class="yui3-u Left blockgary">
							...
							<img src="/reception/img/floor-1-1.png" />
						</div>
						<div class="yui3-u row-330 floorBanner">
							<div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
								...
								<div class="carousel-inner">
									<div class="active item">
										<img src="/reception/img/floor-1-b01.png">
									</div>
									<div class="item">
										<img src="/reception/img/floor-1-b02.png">
									</div>
									<div class="item">
										<img src="/reception/img/floor-1-b03.png">
									</div>
								</div>
						...
						<div class="yui3-u row-220 split">
							...
							<div class="floor-conver-pit">
								<img src="/reception/img/floor-1-2.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="/reception/img/floor-1-3.png" />
							</div>
						</div>
						<div class="yui3-u row-218 split">
							<img src="/reception/img/floor-1-4.png" />
						</div>
						<div class="yui3-u row-220 split">
							<span class="floor-x-line"></span>
							<div class="floor-conver-pit">
								<img src="/reception/img/floor-1-5.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="/reception/img/floor-1-6.png" />
							</div>
						</div>
					</div>
				</div>
	...
	<div class="brand">
		<div class="py-container">
			<ul class="Brand-list blockgary">
				<li class="Brand-item">
					<img src="/reception/img/brand_21.png" />
				</li>
				<li class="Brand-item"><img src="/reception/img/brand_03.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_05.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_07.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_09.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_11.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_13.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_15.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_17.png" /></li>
				<li class="Brand-item"><img src="/reception/img/brand_19.png" /></li>
			</ul>
		</div>
	</div>
	<!-- 底部栏位 -->
					...
					<div class="tbar-panel-main">
						<div class="tbar-panel-content J-panel-content">
							<div class="jt-history-wrap">
								<ul>
									<!--<li class="jth-item">
										<a href="#" class="img-wrap"> <img src=".portal//reception/img/like_03.png" height="100" width="100" /> </a>
										<a class="add-cart-button" href="#" target="_blank">加入购物车</a>
										<a href="#" target="_blank" class="price">￥498.00</a>
									</li>
									<li class="jth-item">
										<a href="#" class="img-wrap"> <img src="portal//reception/img/like_02.png" height="100" width="100" /></a>
										<a class="add-cart-button" href="#" target="_blank">加入购物车</a>
										<a href="#" target="_blank" class="price">￥498.00</a>
									</li>-->
								</ul>
...
<script type="text/javascript" src="/reception/js/model/cartModel.js"></script>
<script type="text/javascript" src="/reception/js/czFunction.js"></script>
...
<script type="text/javascript" src="/reception/js/pages/index.js"></script>
<script type="text/javascript" src="/reception/js/widget/cartPanelView.js"></script>
<script type="text/javascript" src="/reception/js/widget/jquery.autocomplete.js"></script>
